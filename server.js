...
const clients = [
  {
    ...
    redirect_uri: "http://localhost:8088/oauth-redirect-handler",
  },
];
...
app.get("/authorize", (req, res) => {
  ...
  const redirectUrl = `${redirect_uri}?code=${authorizationCode}&state=${encodeURIComponent(state)}`;
